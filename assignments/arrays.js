...
function carmodels(){//This function goes each of data for car model and stores in new array carModels
    var i;
...
carmodels();//Function called
carModels.sort();//Array data sorted out
var i;
